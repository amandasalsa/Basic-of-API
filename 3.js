...
app.get("/convert/desimal/:d",(request, response) => {
...
app.get("/convert/binary/:b",(request, response) => {
...
app.get("/convert/octal/:o",(request, response) => {
...
app.get("/convert/hexadecimal/:h",(request, response) => {
